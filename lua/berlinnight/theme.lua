...
theme.set_highlights = function()
  ...
  hl(0, "function", { fg = c.w_function, bg = 'NONE' })
  hl(0, "@tag.builtin.tsx", { fg = c.w_tag_builtin, bg = 'NONE' })
  hl(0, "@tag.builtin.javascript", { fg = c.w_tag_builtin, bg = 'NONE' })
  hl(0, "@tag.javascript", { fg = c.w_tag_tsx, bg = 'NONE' })
  hl(0, "@tag.css", { fg = c.w_tag_css, bg = 'NONE' })
  hl(0, "@tag.tsx", { fg = c.w_tag_tsx, bg = 'NONE' })
  hl(0, "@function.method.call.javascript", { fg = c.w_method, bg = 'NONE' })
  hl(0, "@function.method.call.typescript", { fg = c.w_method, bg = 'NONE' })
  hl(0, "@tag.astro", { fg = c.w_tag_css, bg = 'NONE' })
